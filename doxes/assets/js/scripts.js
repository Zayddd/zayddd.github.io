...
$(window).load(function () {
    ...
    setTimeout(function () {
        ...
        setTimeout(function () {
            ...
            setTimeout(function () {
                $('#home-screen .content-block p').addClass('animated fadeIn');
                $('#home-screen .content-block .social-icons').addClass('animated fadeIn');
                ...
                setTimeout(function () {
                    ...
                    $('#home-screen .content-block .social-icons').css('opacity', '1');
